...
urlpatterns = [
        path('registo/<path:homePage_name>', views.registo_view, name="registo"),
        path('login/<path:homePage_name>', views.login_view, name="login"),
        path('logout/<path:homePage_name>', views.logout_view, name="logout"),
